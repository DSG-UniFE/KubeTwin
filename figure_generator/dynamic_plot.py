...
ax2[0].plot(time, data_by_component['Video Transcoding']['TTP'].rolling(window=2).mean(), color='#F91907', alpha = 0.8, label='Measured')
...
ax2[1].plot(time, data_by_component['Visual Rendering']['TTP'].rolling(window=2).mean(), color = '#12AC10', alpha = 0.8, label='Measured')
...
ax2[2].plot(time, data_by_component['State Management']['TTP'].rolling(window=2).mean(), color = '#B00E97', alpha = 0.8, label='Measured')
